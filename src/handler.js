...
import { addProject, deleteProject, Project, addTodo, setCurrentProject, getCurrentProject, getTodo, updateTodo, deleteTodo } from "./project"
...
function editTodo() {
    ...
    const description = liNodes.find(description => description.classList.contains('description'))
    ...
    dateInput.addEventListener('click', function() {
        const datepicker = new Datepicker(dateInput, {format: 'dd/mm/yyyy'})
        datepicker.show()
        this.addEventListener('changeDate', function() {
            datepicker.hide()
            dateInput.value = Datepicker.formatDate(datepicker.getDate(), 'dd/mm/yyyy')
        })
    }, {once: true})
...
export { projectListeners, todoListeners, changePriority, changeStatus, editTodo }
