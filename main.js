...
function eventHandler() {
    ...
    const datepicker = new vanillajs_datepicker__WEBPACK_IMPORTED_MODULE_3__.Datepicker(date)
    ...
    todoForm.addEventListener('submit', (e) => {
        ...
        projectsList.forEach(p => {
            ...
            const project = _project__WEBPACK_IMPORTED_MODULE_1__.projects[id]
            ;(0,_project__WEBPACK_IMPORTED_MODULE_1__.addTodo)(project.title, todo)
            ;(0,_views__WEBPACK_IMPORTED_MODULE_2__.updateProject)(project)
        })
    })   
    ...
    projectForm.addEventListener('submit', (e) => {
        ...
        ;(0,_views__WEBPACK_IMPORTED_MODULE_2__.showProject)()
    })
}
...
function addProject(project) {
    ...
    ;(0,_views__WEBPACK_IMPORTED_MODULE_0__.updateMenu)()
}
...
function updateMenu() {
    ...
    _project__WEBPACK_IMPORTED_MODULE_0__.projects.forEach(p => {
        const listProject = document.createElement('li')
        const id = _project__WEBPACK_IMPORTED_MODULE_0__.projects.indexOf(p)
...
function showProject() {
    ...
    allProjects.forEach(p => {
        p.addEventListener('click', () => {
            const project = _project__WEBPACK_IMPORTED_MODULE_0__.projects[p.id]
...
(0,_views__WEBPACK_IMPORTED_MODULE_1__.updateMenu)()
;(0,_views__WEBPACK_IMPORTED_MODULE_1__.showProjectForm)()
