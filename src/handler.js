...
function todoListeners() {
	...
	todoForm.addEventListener('submit', (e) => {
		...
		const id = (currentProject.todos.length
...
function editTodo() {
	...
	const date = liNodes.find((d) => d.classList.contains('date'));
	const title = liNodes.find((t) => t.classList.contains('title'));
	const description = liNodes.find((ds) => ds.classList.contains('description'));
	...
	dateInput.addEventListener(
		...
		() => {
			...
			datepicker.show();
			this.addEventListener('changeDate', () => {
				datepicker.hide();
