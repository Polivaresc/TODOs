...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body, button, input, select {\n    font-family: 'Signika', sans-serif;\n}\n\nh1 {\n    margin: 0;\n}\n\nbody {\n    margin: 0;\n    display: flex;\n    flex-direction: column;\n}\n\n.header {\n    font-family: \"Great Vibes\", cursive;\n    background-color: #14C9CB;\n    padding: 10px 40px;\n    font-size: 50px;\n}\n\nmain {\n    display: flex;\n}\n\n/* START LEFT MENU */\n\n.left-menu {\n    flex-shrink: 0;\n    height: 100vh;\n    width: 250px;\n    padding: 30px 40px;\n    background-color: #2d363b;\n    color: #C9DDEE;\n}\n\n.new-project {\n    font-size: medium;\n    border: 2px solid #C9DDEE;\n    color: #C9DDEE;\n    border-radius: 100%;\n    font-weight: bold;\n    background: none;\n    margin-left: 20px;\n}\n\n.new-project:hover {\n    transform: scale(1.1);\n}\n\n.menu-titles {\n    color: #14C9CB;\n    font-size: x-large;\n    font-weight: bold;\n}\n\n.projects-list {\n    display: flex;\n    flex-direction: column;\n    list-style: none;\n    padding: 0;\n}\n\n.menu-project {\n    cursor: pointer;\n    padding: 10px;\n}\n\n.menu-project:hover {\n    background-color: #171c1f;\n}\n\n/* END LEFT MENU */\n\n#project-form {\n    height: 200px;\n    padding: 40px 80px;\n}\n\n/* START PROJECT PAGE */\n\n.project-page {\n    padding: 40px 80px;\n    display: none;\n}\n\n.new-todo {\n    font-size: medium;\n    border: 2px solid black;\n    border-radius: 100%;\n    font-weight: bold;\n    background: none;\n}\n\n.new-todo:hover {\n    transform: scale(1.1);\n}\n\n/* END PROJECT PAGE */\n\n/* START TODO FORM */\n\n#todo-form {\n    height: 300px;\n    padding: 40px 80px;\n}\n\n.template-form {\n    display: none;\n    grid-template-columns: repeat(2, auto);\n    gap: 20px;\n    width: 20%;\n    text-align: right;\n    color: #53646d;\n    padding: 50px;\n}\n\n.submit-button, .cancel-button {\n    padding: 10px 0;\n    font-size: medium;\n    border: 2px solid #14C9CB;\n}\n\n.cancel-button {\n    background: none;\n}\n\n.cancel-button:hover {\n    background-color: #14c8cb88;\n}\n\n.submit-button {\n    background-color: #14C9CB;\n}\n\n.submit-button:hover {\n    background-color: #0b93a8;\n    border-color: #0b93a8;\n}\n\n.form-title {\n    color: black;\n    grid-column: 1/3;\n    text-align: left;\n    margin: 0px;\n    border-bottom: 1px solid #C9DDEE;\n}\n\n.priority-checkbox {\n    text-align: left;\n}\n\ninput, select {\n    color: #53646d;\n    padding: 5px;\n    background: none;\n    border: 1px solid #C9DDEE;\n}\n\ninput:focus, select:focus, input:hover, select:hover {\n    border-bottom: 2px solid #14C9CB;\n}\n\nselect:hover, button:hover {\n    cursor: pointer;\n}\n\n/* END TODO FORM */", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,kCAAkC;AACtC;;AAEA;IACI,SAAS;AACb;;AAEA;IACI,SAAS;IACT,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,mCAAmC;IACnC,yBAAyB;IACzB,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,aAAa;AACjB;;AAEA,oBAAoB;;AAEpB;IACI,cAAc;IACd,aAAa;IACb,YAAY;IACZ,kBAAkB;IAClB,yBAAyB;IACzB,cAAc;AAClB;;AAEA;IACI,iBAAiB;IACjB,yBAAyB;IACzB,cAAc;IACd,mBAAmB;IACnB,iBAAiB;IACjB,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,cAAc;IACd,kBAAkB;IAClB,iBAAiB;AACrB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,gBAAgB;IAChB,UAAU;AACd;;AAEA;IACI,eAAe;IACf,aAAa;AACjB;;AAEA;IACI,yBAAyB;AAC7B;;AAEA,kBAAkB;;AAElB;IACI,aAAa;IACb,kBAAkB;AACtB;;AAEA,uBAAuB;;AAEvB;IACI,kBAAkB;IAClB,aAAa;AACjB;;AAEA;IACI,iBAAiB;IACjB,uBAAuB;IACvB,mBAAmB;IACnB,iBAAiB;IACjB,gBAAgB;AACpB;;AAEA;IACI,qBAAqB;AACzB;;AAEA,qBAAqB;;AAErB,oBAAoB;;AAEpB;IACI,aAAa;IACb,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,sCAAsC;IACtC,SAAS;IACT,UAAU;IACV,iBAAiB;IACjB,cAAc;IACd,aAAa;AACjB;;AAEA;IACI,eAAe;IACf,iBAAiB;IACjB,yBAAyB;AAC7B;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,2BAA2B;AAC/B;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,yBAAyB;IACzB,qBAAqB;AACzB;;AAEA;IACI,YAAY;IACZ,gBAAgB;IAChB,gBAAgB;IAChB,WAAW;IACX,gCAAgC;AACpC;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,cAAc;IACd,YAAY;IACZ,gBAAgB;IAChB,yBAAyB;AAC7B;;AAEA;IACI,gCAAgC;AACpC;;AAEA;IACI,eAAe;AACnB;;AAEA,kBAAkB","sourcesContent":["body, button, input, select {\n    font-family: 'Signika', sans-serif;\n}\n\nh1 {\n    margin: 0;\n}\n\nbody {\n    margin: 0;\n    display: flex;\n    flex-direction: column;\n}\n\n.header {\n    font-family: \"Great Vibes\", cursive;\n    background-color: #14C9CB;\n    padding: 10px 40px;\n    font-size: 50px;\n}\n\nmain {\n    display: flex;\n}\n\n/* START LEFT MENU */\n\n.left-menu {\n    flex-shrink: 0;\n    height: 100vh;\n    width: 250px;\n    padding: 30px 40px;\n    background-color: #2d363b;\n    color: #C9DDEE;\n}\n\n.new-project {\n    font-size: medium;\n    border: 2px solid #C9DDEE;\n    color: #C9DDEE;\n    border-radius: 100%;\n    font-weight: bold;\n    background: none;\n    margin-left: 20px;\n}\n\n.new-project:hover {\n    transform: scale(1.1);\n}\n\n.menu-titles {\n    color: #14C9CB;\n    font-size: x-large;\n    font-weight: bold;\n}\n\n.projects-list {\n    display: flex;\n    flex-direction: column;\n    list-style: none;\n    padding: 0;\n}\n\n.menu-project {\n    cursor: pointer;\n    padding: 10px;\n}\n\n.menu-project:hover {\n    background-color: #171c1f;\n}\n\n/* END LEFT MENU */\n\n#project-form {\n    height: 200px;\n    padding: 40px 80px;\n}\n\n/* START PROJECT PAGE */\n\n.project-page {\n    padding: 40px 80px;\n    display: none;\n}\n\n.new-todo {\n    font-size: medium;\n    border: 2px solid black;\n    border-radius: 100%;\n    font-weight: bold;\n    background: none;\n}\n\n.new-todo:hover {\n    transform: scale(1.1);\n}\n\n/* END PROJECT PAGE */\n\n/* START TODO FORM */\n\n#todo-form {\n    height: 300px;\n    padding: 40px 80px;\n}\n\n.template-form {\n    display: none;\n    grid-template-columns: repeat(2, auto);\n    gap: 20px;\n    width: 20%;\n    text-align: right;\n    color: #53646d;\n    padding: 50px;\n}\n\n.submit-button, .cancel-button {\n    padding: 10px 0;\n    font-size: medium;\n    border: 2px solid #14C9CB;\n}\n\n.cancel-button {\n    background: none;\n}\n\n.cancel-button:hover {\n    background-color: #14c8cb88;\n}\n\n.submit-button {\n    background-color: #14C9CB;\n}\n\n.submit-button:hover {\n    background-color: #0b93a8;\n    border-color: #0b93a8;\n}\n\n.form-title {\n    color: black;\n    grid-column: 1/3;\n    text-align: left;\n    margin: 0px;\n    border-bottom: 1px solid #C9DDEE;\n}\n\n.priority-checkbox {\n    text-align: left;\n}\n\ninput, select {\n    color: #53646d;\n    padding: 5px;\n    background: none;\n    border: 1px solid #C9DDEE;\n}\n\ninput:focus, select:focus, input:hover, select:hover {\n    border-bottom: 2px solid #14C9CB;\n}\n\nselect:hover, button:hover {\n    cursor: pointer;\n}\n\n/* END TODO FORM */"],"sourceRoot":""}]);
// Exports
...
function updateMenu() {
    ...
    _project__WEBPACK_IMPORTED_MODULE_1__.projects.forEach(p => {
...
(0,_handler__WEBPACK_IMPORTED_MODULE_1__.showProjectForm)()
;(0,_handler__WEBPACK_IMPORTED_MODULE_1__.createProject)()
;(0,_handler__WEBPACK_IMPORTED_MODULE_1__.showProjectPage)()
// updateMenu()
// eventHandler()
